<!--<template>-->
  <!--<div class="page lists-show">-->
    <!--&lt;!&ndash; 头部模块 &ndash;&gt;-->
    <!--<nav>-->
      <!--&lt;!&ndash; 当用户浏览车窗口尺寸小于40em时候，显示手机端的菜单图标 &ndash;&gt;-->
      <!--<div class="form list-edit-form" v-show="isUpdate">-->
        <!--&lt;!&ndash; 当用户点击标题进入修改状态，就显示当前内容可以修改 &ndash;&gt;-->
      ...
      <!--<div class="nav-group" @click="$store.dispatch('updateMenu')" v-show="!isUpdate">-->
        ...
        <!--</a>-->
      <!--</div>-->
      <!--&lt;!&ndash; 显示标题和数字模块 &ndash;&gt;-->
      <!--<h1 class="title-page">-->
        <!--<span class="title-wrapper">{{todo.title}}</span>  &lt;!&ndash; title:标题 绑定标题 &ndash;&gt;-->
        <!--<span class="count-list">{{todo.count || 0}}</span>&lt;!&ndash; count:数量 绑定代办单项熟练&ndash;&gt;-->
      <!--</h1>-->
      <!--&lt;!&ndash; 右边显示删除图标和锁定图标的模块 &ndash;&gt;-->
      <!--<div class="nav-group right">-->
        <!--<div class="options-web">-->
          <!--<a class=" nav-item">-->
            <!--&lt;!&ndash; icon-lock锁定的图标-->
            <!--icon-unlock：非锁定的图标-->
            <!--&ndash;&gt;-->
        ...
        <!--</div>-->
      <!--</div>-->
      <!--&lt;!&ndash; 用户新增代办事项的input模块 &ndash;&gt;-->
      <!--<div class=" form todo-new input-symbol">-->
        <!--&lt;!&ndash; 绑定disabled值，当todo.locked为绑定的时候，禁止input输入,双向绑定text,和监听input的回车事件@keyup.enter &ndash;&gt;-->
